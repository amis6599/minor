    ...
    <header>
        <div class="w3-container">
           <center>
                ...
                <form action="student.jsp" style="display:inline">
                      <button class="w3-btn w3-teal w3-round-jumbo" style="width:13%">My Dashboard</button>
                </form> 
                <div class="w3-dropdown-hover ">
                    ...
                    <div  class="w3-dropdown-content w3-card-8 w3-round-jumbo" style="width: 15%">
                        <a href="studentUpdateInfo.jsp" class="w3-round-jumbo">Edit Information</a>
